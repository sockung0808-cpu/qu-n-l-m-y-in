...
export function getStringListFromEnv(key) {
    return getStringFromEnv(key)
        ...
        .map(v => v.trim())
        .filter(s => s !== '');
}//# sourceMappingURL=http://go/sourcemap/sourcemaps/3a67af7b780e0bfc8d32aefa96b8ff1cb8817f80/node_modules/@opentelemetry/core/build/esm/platform/node/environment.js.map