...
const solidjsTrustedTypesPolicy = window.trustedTypes?.createPolicy('solidjs', { createHTML: value => value });
function template(html, isImportNode, isSVG, isMathML) {
  let node;
  const create = () => {
    const t = isMathML ? document.createElementNS("http://www.w3.org/1998/Math/MathML", "template") : document.createElement("template");
    t.innerHTML = solidjsTrustedTypesPolicy ? solidjsTrustedTypesPolicy.createHTML(html) : html;
...
function innerHTML(parent, content) {
  !sharedConfig.context && (parent.innerHTML = solidjsTrustedTypesPolicy ? solidjsTrustedTypesPolicy.createHTML(content) : content);
}
